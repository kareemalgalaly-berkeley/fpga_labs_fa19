...
#<Session mode="Reload" path="/home/cc/eecs151/fa19/class/eecs151-acn/fpga_labs_fa19/lab3/sim/DVEfiles/session.tcl" type="Debug">
...
gui_sg_addsignal -group "$_session_group_4" { z1top_testbench.top.aud_pwm }

set _session_group_5 Group2
gui_sg_create "$_session_group_5"
set Group2 "$_session_group_5"

gui_sg_addsignal -group "$_session_group_5" { z1top_testbench.top.aud_pwm }
...
gui_open_source -id ${Source.1}  -replace -active z1top_testbench.top /home/cc/eecs151/fa19/class/eecs151-acn/fpga_labs_fa19/lab3/src/z1top.v
...
gui_marker_move -id ${Wave.1} {C1} 27
