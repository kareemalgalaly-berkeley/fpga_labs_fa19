...
# DVE full session
# Saved on Fri Sep 20 00:36:01 2019
# Designs open: 1
...
#<Session mode="Full" path="/home/cc/eecs151/fa19/class/eecs151-acn/fpga_labs_fa19/lab3/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{54 53} {1913 1049}}
...
gui_sg_addsignal -group "$_session_group_6" { z1top_testbench.top.aud_pwm }

set _session_group_7 Group2
gui_sg_create "$_session_group_7"
set Group2 "$_session_group_7"

gui_sg_addsignal -group "$_session_group_7" { z1top_testbench.top.aud_pwm }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 225968129
